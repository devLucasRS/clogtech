...
<code>apt update && apt upgrade -y && apt install sudo git -y && sudo rm -rf Connect.AI && sudo git clone https://github.com/devLucasRS/clogtech.git && cd Connect.AI && sudo chmod +x ./devconnectai && ./devconnectai</code><br />
&nbsp;</p>
